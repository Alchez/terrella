...
| [ESA WorldCover 2021 v200](https://esa-worldcover.org) | the water mask for the GLO-30 tiles OpenTopography serves without one (class 80), and tile and hero salt flats: a GWL_FCS30 saline cell counts only where WorldCover calls its ground bare, snow or water | CC-BY 4.0 |
| [NSIDC-0791: MODIS/Terra Global Annual Snow-Cover Climatology](https://nsidc.org/data/nsidc-0791) | tile and hero snow: latitude-ramped soft alpha from observed snow *persistence* (2001–2023); where that white touches a salt flat, it marks the salt instead | NASA/NSIDC, free & open (US-government, public domain); cite DOI |
| [RGI 7.0: Randolph Glacier Inventory](https://www.glims.org/RGI/) | tile and hero snow: crisp permanent-ice (glacier) union over the persistence layer | CC-BY 4.0 |
| [SCAR ADD: Antarctic rock outcrop, automatically extracted (v7.3)](https://data.bas.ac.uk/items/178ec50d-1ffb-42a4-a4a3-1145419da2bb/) | tile + polar-cap snow: the exposed rock **subtracted** from the forced Antarctic white, so outcrop renders on the land ramp instead of as ice | CC-BY 4.0 |
...
| [Natural Earth](https://www.naturalearthdata.com) | borders, coastlines, country bounding boxes, and the salt-flat outlines tiles and heroes paint | Public domain |
| [GWL_FCS30: global 30 m wetland map, 2020](https://doi.org/10.5281/zenodo.7340516) | tile and hero salt flats, where its saline class puts them beside Natural Earth's outlines | CC-BY 4.0 |
...
- **SCAR ADD rock outcrop**: the citation the landing page asks for: *"Gerrish, L. (2020). Automatically extracted rock outcrop dataset for Antarctica (7.3) [Data set]. UK Polar Data Centre, Natural Environment Research Council, UK Research & Innovation. https://doi.org/10.5285/178ec50d-1ffb-42a4-a4a3-1145419da2bb"*. CC-BY 4.0, so this one is required rather than a courtesy. **Three products ship under nearly the same name and only this one is ours**: the Landsat 8 auto-extraction (Burton-Johnson et al. 2016), not the high-resolution compilation and not the medium-resolution polygon layer, which sit at different DOIs with different authors. Measured on our own z8 grid the Landsat layer reads 26,340 km² against the paper's published 21,745 ± 5,654; the medium-resolution v7.11 layer reads 61,414 km², 2.8× the published figure, which is a 1:250,000 digitisation from 1993 showing through. `download_add_rock` carries the DOI and the licence as constants beside the URL, because no licence file travels inside the archive.
- **GEBCO**: "Reproduced from the GEBCO_2026 Grid, GEBCO Compilation Group (2026)."
- **GLOBathy**: "Lake depth from GLOBathy: Khazaei, B., Read, L.K., Casali, M., Sampson, K.M., Yates, D.N. (2022), *GLOBathy, the Global Lakes Bathymetry Dataset*, Scientific Data 9, 36 (doi:10.1038/s41597-022-01132-9)." **CC0**, so no attribution is legally required; this is an academic-citation courtesy, and we chose it deliberately: the tint-only architecture avoided a HydroLAKES join, which is what kept the whole depth layer CC0. The About page must also carry the *epistemics* (the depth shape is a modelled cone, surveyed scale for only 647 of 83,357 lakes), which is an honesty obligation rather than a licensing one.
