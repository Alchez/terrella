...
(six guarded stages) → Blender render **1:29–3:36** → full ~204-country sweep **~10–13 h**, GPU-bound.
...
| Full batch — **~204 heroes** | **~10–13 h** (GPU-bound, occupies the desktop) | per-country resume | `blender/renders/` |
