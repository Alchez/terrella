...
- **Not done, and deliberately Rohan's:** the 2.63 GB upload to R2 and `wrangler deploy`. The archive is packed and verified on disk; the preflight blocks the deploy until it lands.
