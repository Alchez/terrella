...
- Where a new module goes in the pipeline package → [`docs/pipeline-layout.md`](docs/pipeline-layout.md)
...
- How much disk the pipeline's data takes, and what is safe to delete → [`docs/INVENTORY.md`](docs/INVENTORY.md)
