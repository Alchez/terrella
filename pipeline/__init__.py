...
HOW THIS PACKAGE IS LAID OUT, and why nothing in it is grouped by planet: docs/pipeline-layout.md.
It is stated there and deliberately not restated here, because a rule kept
