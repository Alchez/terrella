...
- Salt flats take a tone of their own on both surfaces, outlined by Natural Earth's playas: NSIDC-0791 reads their crust as snow and the water mask reads it as lake, so the salt takes its share of the finished white and is painted last, over the lake. `look/salt.py` owns which ground is salt.
