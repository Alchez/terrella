...
- **Sea ice:** OSI SAF OSI-450-a v3.0 reduced to a 1991–2020 ice-frequency climatology (`look/seaice.py`), chosen over the NSIDC CDR purely on access — anonymous over met.no THREDDS, no token churn.
