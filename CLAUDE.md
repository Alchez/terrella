...
- Snow and glaciers differ between the two surfaces by decision rather than drift. Tiles take NSIDC-0791 persistence plus RGI 7.0 with a latitude-ramped soft alpha, and Antarctica is painted white outright (persistence saturates there but leaves 9 to 14% of the land as clustered fill, RGI region 19 skipped). Heroes take ESA WorldCover class 70, which the tiles replaced because permanent-ice-only left mid- and high-latitude ranges bare.
